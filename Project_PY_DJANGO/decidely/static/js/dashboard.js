...
// Fallback to default options if window.options is empty or undefined
const options = window.options && window.options.length > 0 
    ? window.options 
    : ["Pizza Hut", "Taco Bell", "Subway", "Salad Bar", "Sushi Zen", "Pasta Co"];
